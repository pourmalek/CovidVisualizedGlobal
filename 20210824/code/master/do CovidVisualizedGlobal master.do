...
* This is "do CovidVisualizedGlobal master.do"
                                                                                                          *******************
* Project: Combine and visualize international periodically updating                                      * uptake 20210824 *
...
This file "do CovidVisualizedGlobal master.do" was set up to be run from:
  ...
  where 2021MMDD is the udpate date, e.g. update 20210824
...
if regexm(c(os),"Mac") == 1 {
	global pathCovidVisualizedGlobal "/Users/`usrnam'/Downloads/CovidVisualizedGlobal-main/20210824/code/" 
}
else if regexm(c(os),"Windows") {
	global pathCovidVisualizedGlobal = "C:\Users\\`usrnam'\Downloads\CovidVisualizedGlobal-main\20210824\code\"
}
*
...
data in CovidVisualizedGlobal-main/20210824/output/merge/CovidVisualizedGlobal merge.dta
and graphs stored in:
CovidVisualizedGlobal-main/20210824/output/merge/*.pdf
and CovidVisualizedGlobal-main/20210824/output/IMPE/*.pdf
