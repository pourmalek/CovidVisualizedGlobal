...
This file "do globalcovid master.do" was set up to be run from:
  ...
  where 202YMMDD is the udpate date, e.g. starting with 20210414
...
global pathglobalcovid = "C:\Users\\`usrnam'\Downloads\globalcovid-main\202YMMDD\code\" [for Windows]
...
if regexm(c(os),"Mac") == 1 {
	global pathglobalcovid "/Users/`usrnam'/Downloads/globalcovid-main/20210414/code/" 
}
else if regexm(c(os),"Windows") {
	global pathglobalcovid = "C:\Users\\`usrnam'\Downloads\globalcovid-main\20210414\code\"
}
*
