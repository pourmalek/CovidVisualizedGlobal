...
***************************************************************************
* This is "do globalcovid IMPE.do"
...
* Date update   20210406             // update date of study estimates used here
* Date coverage 01dec2019,04jul2021  // dates covered by study estimates
***************************************************************************
...
* /* turn off time taking tasks after first run by removing * from the beginning of this line
...
import delimited "2021-04-06_v7.csv", clear varnames(1) // * Wait Note: large file size, takes a while ...

save "2021-04-06_v7.dta", replace

*/


use "2021-04-06_v7.dta", clear 
