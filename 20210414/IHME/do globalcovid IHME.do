...
if regexm(c(os),"Mac") == 1 {
	local path "/Users/`usrnam'/Downloads/globalcovid-main/20210414/IHME" 
	di "`path'"
}
else if regexm(c(os),"Windows") == 1 local path "C:\Users\\`usrnam'\Downloads\globalcovid-main\20210414\IHME"
    di "`path'"
...
if regexm(c(os),"Mac") == 1 {
	...
	local path "C:\Users\\`usrnam'\Downloads\globalcovid-main\20210414\IHME""
	di "`path'"
}
*
