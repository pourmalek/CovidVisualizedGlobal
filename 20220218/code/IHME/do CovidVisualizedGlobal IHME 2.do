...
collapse (sum) DayINFMeSmA02S01-inf_hosp_A02S03, by(date)
...
foreach region of local list2 {
	...
	qui append using "IHME `region'.dta"
	
}
*


drop cumulative_all_fully_vaccinated
drop cumulative_all_effectively_vacci
...
rename cumulative_deaths_A02S01 CumDeaA02S01
...
foreach var of varlist DayINFMeSmA02S01-inf_hosp_A02S03 {
