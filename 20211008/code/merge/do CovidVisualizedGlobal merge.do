...
(line DayDeaMeSmA04S00 date, sort lcolor(gold) lwidth(medthick)) /// 6 "LANL"
...
legend(order(1 "JOHN raw" 2 "JOHN smooth" 3 "DELP" 4 "IHME" 5 "IMPE" 6 "LANL smooth" 7 "SRIV") size(small) row(2)) ///
...
(line DayDeaMeSmA04S00 date, sort lcolor(gold) lwidth(medthick)) /// 7 "LANL"
(line DayDeaMeRaA05S00 date, sort lcolor(green)) /// 8 "SRIV"
if date >= td(01jan2020) ///
, xtitle(Date) xlabel(#$yticknalltime, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid)  ///
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, global, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN raw" 2 "JOHN smooth" 3 "DELP" 4 "IHME" 5 "IHME excess" 6 "IMPE" 7 "LANL smooth" 8 "SRIV") size(small) row(2)) ///
subtitle("  .", size(small) color(white)) 
...
(line DayDeaMeSmA04S00 date, sort lcolor(gold) lwidth(medthick)) /// 11 LANL mean
(line DayDeaLoSmA04S00 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL lower
(line DayDeaUpSmA04S00 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL upper
...
ytitle(Daily deaths) title("COVID-19 daily deaths, global, reference scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN smooth" 2 "DELP" 5 "IHME" 8 "IMPE" 11 "LANL smooth" 14 "SRIV") size(small) row(2)) ///
...
(line DayDeaMeSmA04S00 date, sort lcolor(gold) lwidth(medthick)) /// 9 LANL mean
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN smooth" 2 "DELP" 3 "IHME" 6 "IMPE" 9 "LANL smooth" 10 "SRIV") size(small) row(2)) ///
subtitle("after 2021-01-01", size(small)) ///
...
(line DayCasMeSmA04S00 date, sort lcolor(gold) lwidth(medthick)) /// 7 "LANL"
...
5 "LANL cases smooth" 6 "SRIV cases" ) size(small) row(2)) ///
subtitle("  .", size(small) color(white)) 
...
(line DayCasMeSmA04S00 date, sort lcolor(gold) lwidth(medthick)) /// 5 "LANL"
...
(line DayCasMeSmA04S00 date, sort lcolor(gold) lwidth(medthick)) /// 11 LANL mean
(line DayCasLoSmA04S00 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL lower
(line DayCasUpSmA04S00 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL upper
...
"IMPE infections" 11 "LANL cases smooth" 14 "SRIV cases") size(small) row(2)) ///
note("Uncertainty limits: dashed curves") ///
subtitle("after 2021-01-01, w/ uncertainty", size(small))
...
(line DayCasMeSmA04S00 date, sort lcolor(gold) lwidth(medthick)) /// 9 LANL mean
...
"IMPE infections" 9 "LANL cases smooth" 10 "SRIV cases") size(small) row(2)) ///
subtitle("after 2021-01-01", size(small)) ///
note("Better and worse scenarios: tight dot (|||||) curves; IHME and IMPE") 
