...
gen DayCTDMeRaA01S00V04 =  DayCasMeRaA01S00V04 / DayDeaMeRaA01S00V04

label var DayCTDMeRaA01S00V04  "Daily Cases to Deaths S0 DELP"

gen TotCTDMeRaA01S00V04 =  TotCasMeRaA01S00V04 / TotDeaMeRaA01S00V04

label var TotCTDMeRaA01S00V04  "Total Cases to Deaths S0 DELP"  
...
gen DayDERMeRaA01S00V04 = DayDeaMeRaA01S00V04 / DayDeaMeRaA00S00V00

label var DayDERMeRaA01S00V04 "Daily Deaths estim to reported Mean DELP S0 V3"

line DayDeaMeRaA01S00V04  DayDeaMeRaA00S00V00 date
...
gen DayCERMeRaA01S00V04 = DayCasMeRaA01S00V04 / DayCasMeRaA00S00V00

label var DayCERMeRaA01S00V04 "Daily Cases estim to reported Mean DELP S0 V3"
...
gen TotDERMeRaA01S00V04 = TotDeaMeRaA01S00V04 / TotDeaMeRaA00S00V00

label var TotDERMeRaA01S00V04 "Total Deaths estim to reported Mean DELP S0 V3"
...
gen TotCERMeRaA01S00V04 = TotCasMeRaA01S00V04 / TotCasMeRaA00S00V00

label var TotCERMeRaA01S00V04 "Total Cases estim to reported Mean DELP S0 V3"
...
(line DayDeaMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
twoway ///
(line DayDeaMeRaA00S00V00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line DayDeaMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP" mean
(line DayDeaLoRaA01S00V04 date, sort lcolor(red) lpattern(dash)) /// 3 "DELP" lower
(line DayDeaUpRaA01S00V04 date, sort lcolor(red) lpattern(dash)) /// 4 "DELP" upper
...
(line DayCasMeRaA01S00V04 date, sort lcolor(red)) /// 4 "DELP"
...
twoway ///
(line DayCasMeRaA00S00V00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN"
(line DayCasMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
twoway ///
(line DayCasMeRaA00S00V00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line DayCasMeRaA01S00V04  date, sort lcolor(red)) /// 2 DELP mean
(line DayCasLoRaA01S00V04  date, sort lcolor(red) lpattern(dash)) /// 3 DELP lower
(line DayCasUpRaA01S00V04  date, sort lcolor(red) lpattern(dash)) /// 4 DELP upper
...
(line TotDeaMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
twoway ///
(line TotDeaMeRaA00S00V00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line TotDeaMeRaA01S00V04 date, sort lcolor(red)) /// 2 DELP mean
(line TotDeaLoRaA01S00V04 date, sort lcolor(red) lpattern(dash)) /// 3 DELP lower
(line TotDeaUpRaA01S00V04 date, sort lcolor(red) lpattern(dash)) /// 4 DELP upper
...
(line TotCasMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
(line TotCasMeRaA00S00V00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line TotCasMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
(line TotCasLoRaA01S00V04 date, sort lcolor(red) lpattern(dash)) /// 3 "DELP"
(line TotCasUpRaA01S00V04 date, sort lcolor(red) lpattern(dash)) /// 4 "DELP"
...
(line DayCfrMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
twoway ///
(line DayCfrMeRaA01S00V04 date, sort lcolor(red)) /// 1 "DELP" mean
(line DayCfrLoRaA01S00V04 date, sort lcolor(red*.3) lpattern(dash)) /// 2 "DELP" lower
(line DayCfrUpRaA01S00V04 date, sort lcolor(red*.3) lpattern(dash)) /// 3 "DELP" upper
...
/*
twoway ///
(line DayHosMeRaA01S00V04 date, sort lcolor(red)  lwidth(thick)) /// 1 DELP Hospitalized (Daily Cases Active Hospitalized Mean DELP S0 V3)
(line DayVenMeRaA01S00V04 date, sort lcolor(red) lpattern(dash)  lwidth(thick)) /// 2 DELP Ventilated (Daily Cases Active Ventilated Mean DELP S0 V3)
...
(line DayCTDMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
(line TotCTDMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
(line DayDERMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
(line DayCERMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
(line TotDERMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
...
(line TotCERMeRaA01S00V04 date, sort lcolor(red)) /// 2 "DELP"
