...
foreach region of local list {
	...
	* visualize timing of deaths and cases peaks
	...
	qui graph export "graph `region' 8 COVID-19 daily deaths and cases timing, smooth, `region', Johns Hopkins.pdf", replace
...
(line TotDeaMeRaA00S00AMR1 date, sort lcolor(orange)) ///
(line TotDeaMeRaA00S00AMR2 date, sort lcolor(purple)) ///
...
(line TotCasMeRaA00S00AMR1 date, sort lcolor(orange)) ///
(line TotCasMeRaA00S00AMR2 date, sort lcolor(purple)) ///
...
(line DayCfrMeRaA00S00AMR1 date, sort lcolor(orange)) ///
(line DayCfrMeRaA00S00AMR2 date, sort lcolor(purple)) ///
...
(line DayCasMeSmA00S00AMR1 date, sort lpattern(dash) lcolor(orange)) ///
(line DayDeaMeSmA00multipAMR1 date, sort lcolor(orange)) ///
(line DayCasMeSmA00S00AMR2 date, sort lpattern(dash) lcolor(purple)) ///
(line DayDeaMeSmA00multipAMR2 date, sort lcolor(purple)) ///
