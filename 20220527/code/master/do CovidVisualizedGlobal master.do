...
* This is "do CovidVisualizedGlobal master.do"
                                                                                                          *******************
* Project: Combine and visualize international periodically updating                                      * uptake 20220527 *
...
if regexm(c(os),"Mac") == 1 {
	global pathCovidVisualizedGlobal "/Users/`usrnam'/Downloads/CovidVisualizedGlobal-main/20220527/code/" 
}
else if regexm(c(os),"Windows") {
	global pathCovidVisualizedGlobal = "C:\Users\\`usrnam'\Downloads\CovidVisualizedGlobal-main\20220527\code\"
}
*
...
do "$pathCovidVisualizedGlobal/IMPE/do CovidVisualizedGlobal IMPE.do" // IMPE update 20220315 was released on 20220505 and is 60 days old on 20220527. Not included.
