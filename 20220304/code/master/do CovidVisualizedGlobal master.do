...
global IMPEdate 2022-01-20_v9 // IMPE 20220120 is > one month old and is not included in the graphs.
*            3/ -------------
...
if regexm(c(os),"Mac") == 1 {
	global pathCovidVisualizedGlobal "/Users/`usrnam'/Downloads/CovidVisualizedGlobal-main/20220304/code/" 
}
else if regexm(c(os),"Windows") {
	global pathCovidVisualizedGlobal = "C:\Users\\`usrnam'\Downloads\CovidVisualizedGlobal-main\20220304\code\"
}
*
...
// do "$pathCovidVisualizedGlobal/SRIV/do CovidVisualizedGlobal SRIV.do" // SRIV Highly implausibly high estimate.
