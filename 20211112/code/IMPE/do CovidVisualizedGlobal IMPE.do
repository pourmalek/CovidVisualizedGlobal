...
/*
copy https://raw.githubusercontent.com/mrc-ide/global-lmic-reports/master/data/2021-11-03_v9.csv.zip 2021-11-03_v9.csv.zip
unzipfile 2021-11-03_v9.csv.zip, replace
erase 2021-11-03_v9.csv.zip


On 20210920, IMPE removed their THREE available previous updates, and uploaded their new update, 2021-11-03_v9.csv.zip.
 
For use in this code, IMPE estimates for Global level from "2021-11-03_v9.csv" is stored in file "2021-11-03_v9 Global.csv".
*/
...
import delimited "2021-11-03_v9 Global.csv", clear varnames(1) // * Wait Note: large file size, takes a while ...
