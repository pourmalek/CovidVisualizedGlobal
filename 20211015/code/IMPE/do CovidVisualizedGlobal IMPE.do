...
On 20210920, IMPE removed their THREE available previous updates, and uploaded their new update, 2021-10-06_v8.csv.zip.
 
For use in this code, IMPE estimates for Global level from "2021-10-06_v8.csv" is stored in file "2021-10-06_v8 Global.csv".
*/
...
import delimited "2021-10-06_v8 Global.csv", clear varnames(1) // * Wait Note: large file size, takes a while ...
