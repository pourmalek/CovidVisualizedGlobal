...
***************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 2021-09-09 (old), with 2021-09-09 (new) <<--       <<<--- * change update date here *
                                                                                                         ***************************																						 
...
/*
copy https://raw.githubusercontent.com/mrc-ide/global-lmic-reports/master/data/2021-09-09_v8.csv.zip 2021-09-09_v8.csv.zip
...
For use in this code, IMPE estimates for Global level from "2021-09-09_v8.csv" is stored in file "2021-09-09_v8 Global.csv".
*/
...
import delimited "2021-09-09_v8 Global.csv", clear varnames(1) // * Wait Note: large file size, takes a while ...
