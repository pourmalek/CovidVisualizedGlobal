...
(line DayDeaMeRaA03S02AMR1 date, sort lcolor(red) lpattern(dash)) ///
(line DayDeaMeRaA03S02AMR2 date, sort lcolor(red) lpattern(dash_3dot)) ///
...
(line DayINFMeRaA03S02AMR1 date, sort lcolor(red) lpattern(dash)) ///
(line DayINFMeRaA03S02AMR2 date, sort lcolor(red) lpattern(dash_3dot)) ///
...
(line TotDeaMeRaA03S02AMR1 date, sort lcolor(red) lpattern(dash)) ///
(line TotDeaMeRaA03S02AMR2 date, sort lcolor(red) lpattern(dash_3dot)) ///
...
(line TotINFMeRaA03S02AMR1 date, sort lcolor(red) lpattern(dash)) ///
(line TotINFMeRaA03S02AMR2 date, sort lcolor(red) lpattern(dash_3dot)) ///
