...
### Selected graphs from previous uptakes are stored in another web page: [RESULTS, PREVIOUS UPTAKES](https://github.com/pourmalek/covir2#iv-selected-graphs-from-previous-uptakes-1), _links to which are also provided below:_
