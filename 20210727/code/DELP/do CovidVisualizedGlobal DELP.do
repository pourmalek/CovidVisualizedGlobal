...
***************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 20210727 (old), with 20210727 (new) <<--           <<<--- * change update date here *
                                                                                                         ***************************


clear

copy https://raw.githubusercontent.com/COVIDAnalytics/website/master/data/predicted/Global_V4_since100_20210727.csv Global_V4_since100_20210727.csv

import delimited using "Global_V4_since100_20210727.csv", clear varnames(1)
