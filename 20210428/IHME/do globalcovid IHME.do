...
if regexm(c(os),"Mac") == 1 {
	local path "/Users/`usrnam'/Downloads/globalcovid-main/20210428/code/IHME" 
	di "`path'"
}
else if regexm(c(os),"Windows") == 1 local path "C:\Users\\`usrnam'\Downloads\globalcovid-main\20210428\code\IHME"
    di "`path'"
...
if regexm(c(os),"Mac") == 1 {
	...
	local path "C:\Users\\`usrnam'\Downloads\globalcovid-main\20210428\code\IHME"
	di "`path'"
}
*
