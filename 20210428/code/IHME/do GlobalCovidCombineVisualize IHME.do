...
local up_date "2021-04-23"		// update date 

local up_dir  "2021_04_22"		// update directory 
...
if date >= td(01jan2020) ///
, xtitle(Date) xlabel(#19, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.5fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
