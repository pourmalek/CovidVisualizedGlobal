...
ytitle(Daily deaths) title("COVID-19 daily deaths, global, reference scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN smooth" 2 "DELP" 5 "IHME" 8 "IMPE" 11 "LANL" 14 "SRIV") size(small) row(1)) ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN smooth" 2 "DELP" 3 "IHME" 6 "IMPE" 9 "LANL" 10 "SRIV") size(small) row(1)) ///
subtitle("after 2021-01-01", size(small)) ///
...
twoway ///
(line DayDeaMeRaA00S00 date, sort lcolor(cyan) lwidth(medium) lpattern(tight_dot)) /// 1 "JOHN raw"
(line DayDeaMeSmA00S00 date, sort lcolor(cyan) lwidth(medium)) /// 2 "JOHN smooth"
...
twoway ///
(line DayDeaMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN raw"
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN cases" 2 "DELP" 3 "IHME infections" 4 "IMPE infections" ///
...
twoway ///
(line DayCasMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN"
...
twoway ///
(line TotDeaMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN"
...
twoway ///
(line TotCasMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN"
...
twoway ///
(line DayCfrMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN"
...
twoway ///
(line DayCTDMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN"
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases or infections to deaths) title("COVID-19 daily cases or infections to deaths, global, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN cases" 2 "DELP cases infections" 3 "IHME infections" 4 "IMPE" ///
5 "LANL cases" 6 "SRIV cases") size(small) row(2)) ///
subtitle("  .", size(small) color(white))
...
twoway ///
(line TotCTDMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN"
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases or infections to deaths) title("COVID-19 total cases or infections to deaths, global, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN cases" 2 "DELP cases infections" 3 "IHME infections" 4 "IMPE" ///
5 "LANL cases" 6 "SRIV cases") size(small) row(2)) ///
subtitle("  .", size(small) color(white))
...
twoway ///
(line DayDERMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN"
...
twoway ///
(line DayCERMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN"
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases or infections estimated to reported) title("COVID-19 daily cases estimated to reported, global, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN cases" 2 "DELP cases" 3 "IHME infections" 4 "IMPE infections" ///
5 "LANL cases" 6 "SRIV cases") size(small) row(2)) ///
subtitle("daily cases or infections estimated, to reported cases", size(small))
...
twoway ///
(line TotDERMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN
...
twoway ///
(line TotCERMeRaA00S00 date, sort lcolor(cyan) lwidth(medthick)) /// 1 "JOHN"
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases or infections estimated to reported) title("COVID-19 total cases estimated to reported, global, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 3 "IHME" 4 "IMPE" 5 "LANL" 6 "SRIV") size(small) row(1)) ///
subtitle("total cases or infections	 estimated, to reported cases", size(small))
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases or infections estimated to reported) title("COVID-19 total cases or infections estimated to reported, global, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 3 "IHME" 4 "IMPE" 5 "LANL" 6 "SRIV") size(small) row(1)) ///
subtitle("total cases or infections	 estimated, to reported cases", size(small))
