...
ytitle(Total deaths) title("COVID-19 total deaths, global, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 3 "IHME" 4 "IHME excess" 5 "IMPE" 6 "LANL" 7 "SRIV") size(small) row(2)) ///
subtitle("  .", size(small) color(white))
...
subtitle("after 2021-01-01, without JOHN, LANL, with uncertainty", size(small))
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.1fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily % change in mobility from baseline) title("COVID-19 daily % change in mobility, IHME, 3 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
graph save "graph 94 COVID-19 percent cumulative vaccinated, global.gph", replace
graph export "graph 94 COVID-19 percent cumulative vaccinated, global.pdf", replace
...
DayINFMeSmA02S01 DayINFUpSmA02S01 DayINFMeSmA02S03 DayINFUpSmA02S03 /// IHME Daily Infections, Mean Upper, Reference Worse scenrio
TotINFMeSmA02S01 TotINFUpSmA02S01 TotINFMeSmA02S03 TotINFUpSmA02S03 /// IHME Total Infections, Mean Upper, Reference Worse scenrio
...
summ DayDeaMeSmA02S01 if date > td(01Jul2021)

gen double DayDeaMeSmA02S01_LPV = r(max)

label var DayDeaMeSmA02S01_LPV "Daily deaths IHME reference scenario, mean, value"

summ date if DayDeaMeSmA02S01 == DayDeaMeSmA02S01_LPV & date > td(01Jul2021)
...
summ DayDeaUpSmA02S01 if date > td(01Jul2021)

gen double DayDeaUpSmA02S01_LPV = r(max)

label var DayDeaUpSmA02S01_LPV "Daily deaths IHME reference scenario, upper, value"

summ date if DayDeaUpSmA02S01 == DayDeaUpSmA02S01_LPV & date > td(01Jul2021)
...
summ DayDeaMeSmA02S03 if date > td(01Jul2021)

gen double DayDeaMeSmA02S03_LPV = r(max)

label var DayDeaMeSmA02S03_LPV "Daily deaths IHME worse scenario, mean, value"

summ date if DayDeaMeSmA02S03 == DayDeaMeSmA02S03_LPV & date > td(01Jul2021)
...
summ DayDeaUpSmA02S03 if date > td(01Jul2021)

gen double DayDeaUpSmA02S03_LPV = r(max)

label var DayDeaUpSmA02S03_LPV "Daily deaths IHME worse scenario, upper, value"

summ date if DayDeaUpSmA02S03 == DayDeaUpSmA02S03_LPV & date > td(01Jul2021)
...
summ DayINFMeSmA02S01 if date > td(01Jul2021)

gen double DayINFMeSmA02S01_LPV = r(max)

label var DayINFMeSmA02S01_LPV "Daily infections IHME reference scenario, mean, value"

summ date if DayINFMeSmA02S01 == DayINFMeSmA02S01_LPV & date > td(01Jul2021)

gen DayINFMeSmA02S01_LPD = r(mean)

format DayINFMeSmA02S01_LPD %tdDDMonCCYY

label var DayINFMeSmA02S01_LPD "Daily infections IHME reference scenario, mean, date"



* Daily infections reference scenario, upper

summ DayINFUpSmA02S01 if date > td(01Jul2021)

gen double DayINFUpSmA02S01_LPV = r(max)

label var DayINFUpSmA02S01_LPV "Daily infections IHME reference scenario, upper, value"

summ date if DayINFUpSmA02S01 == DayINFUpSmA02S01_LPV & date > td(01Jul2021)

gen DayINFUpSmA02S01_LPD = r(mean)

format DayINFUpSmA02S01_LPD %tdDDMonCCYY

label var DayINFUpSmA02S01_LPD "Daily infections IHME reference scenario, upper, date"
...
summ DayINFMeSmA02S03 if date > td(01Jul2021)

gen double DayINFMeSmA02S03_LPV = r(max)

label var DayINFMeSmA02S03_LPV "Daily infections IHME worse scenario, mean, value"

summ date if DayINFMeSmA02S03 == DayINFMeSmA02S03_LPV & date > td(01Jul2021)

gen DayINFMeSmA02S03_LPD = r(mean)

format DayINFMeSmA02S03_LPD %tdDDMonCCYY

label var DayINFMeSmA02S03_LPD "Daily infections IHME worse scenario, mean, date"



* Daily infections worse scenario, upper

summ DayINFUpSmA02S03 if date > td(01Jul2021)

gen double DayINFUpSmA02S03_LPV = r(max)

label var DayINFUpSmA02S03_LPV "Daily infections IHME worse scenario, upper, value"

summ date if DayINFUpSmA02S03 == DayINFUpSmA02S03_LPV & date > td(01Jul2021)

gen DayINFUpSmA02S03_LPD = r(mean)

format DayINFUpSmA02S03_LPD %tdDDMonCCYY

label var DayINFUpSmA02S03_LPD "Daily infections IHME worse scenario, upper, date"
...
summ DayDeaMeRaA03S02 if date > td(01Jul2021)

gen double DayDeaMeRaA03S02_LPV = r(max)

label var DayDeaMeRaA03S02_LPV "Daily deaths IMPE reference scenario, mean, value"

summ date if DayDeaMeRaA03S02 == DayDeaMeRaA03S02_LPV 

gen DayDeaMeRaA03S02_LPD = r(mean)

format DayDeaMeRaA03S02_LPD %tdDDMonCCYY

label var DayDeaMeRaA03S02_LPD "Daily deaths IMPE reference scenario, mean, date"
...
summ DayDeaUpRaA03S02 if date > td(01Jul2021)

gen double DayDeaUpRaA03S02_LPV = r(max)

label var DayDeaUpRaA03S02_LPV "Daily deaths IMPE reference scenario, upper, value"

summ date if DayDeaUpRaA03S02 == DayDeaUpRaA03S02_LPV & date > td(01Jul2021)
...
summ DayDeaMeRaA03S03 if date > td(01Jul2021)

gen double DayDeaMeRaA03S03_LPV = r(max)

label var DayDeaMeRaA03S03_LPV "Daily deaths IMPE worse scenario, mean, value"

summ date if DayDeaMeRaA03S03 == DayDeaMeRaA03S03_LPV & date > td(01Jul2021)
...
summ DayDeaUpRaA03S03 if date > td(01Jul2021)

gen double DayDeaUpRaA03S03_LPV = r(max)

label var DayDeaUpRaA03S03_LPV "Daily deaths IMPE worse scenario, upper, value"

summ date if DayDeaUpRaA03S03 == DayDeaUpRaA03S03_LPV & date > td(01Jul2021)
...
gen double DayINFMeRaA03S02_LPV = r(max)
...
gen double DayINFUpRaA03S02_LPV = r(max)
...
gen double DayINFMeRaA03S03_LPV = r(max)
...
gen double DayINFUpRaA03S03_LPV = r(max)
...
DayINFMeSmA02S01_LPV DayINFMeSmA02S01_LPD DayINFUpSmA02S01_LPV DayINFUpSmA02S01_LPD ///
DayINFMeSmA02S03_LPV DayINFMeSmA02S03_LPD DayINFUpSmA02S03_LPV DayINFUpSmA02S03_LPD ///
DayDeaMeRaA03S02_LPV DayDeaMeRaA03S02_LPD DayDeaUpRaA03S02_LPV DayDeaUpRaA03S02_LPD ///
...
DayINFMeSmA02S01_LPV DayINFUpSmA02S01_LPV ///
DayINFMeSmA02S03_LPV DayINFUpSmA02S03_LPV ///
DayDeaMeRaA03S02_LPV DayDeaUpRaA03S02_LPV ///
