...
* Daily cases (graph numbers start w/ 21)
...
* total cases (graph numbers start w/ 41)
...
* daily cfr (graph numbers start w/ 51)
...
8 "IMPE ICU incidence") rows(4) size(small)) ///
subtitle("IMPE Hospital incidence and ICU incidence not available in this IMPE update", size(small))
...
// not available in this IMPE update
...
4 "IHME Admissions" 5 "IHME ICU new" 6 "IMPE ICU incidence") rows(3) size(small)) ///
subtitle("IMPE Hospital incidence and ICU incidence not available in this IMPE update", size(small))
...
* daily cases to deaths (CTD) (graph numbers start w/ 71)
