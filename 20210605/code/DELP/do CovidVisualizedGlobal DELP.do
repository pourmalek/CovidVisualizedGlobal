...
***************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 20210605 (old), with 20210605 (new) <<--           <<<--- * change update date here *
                                                                                                         ***************************


clear

copy https://raw.githubusercontent.com/COVIDAnalytics/website/master/data/predicted/Global_V4_20210605.csv Global_V4_20210605.csv

import delimited using "Global_V4_20210605.csv", clear varnames(1)
